        ...
        for(let j=0;j<data[i].length;j++){
            ...
            if(numbers.indexOf(currentChar) != -1){
                if(!isCurrentNumAdjacent){
                    isCurrentNumAdjacent = isCellAdjacentToSymbol(i,j);
                }
                ...
                if(isCurrentNumAdjacent){
                    ...
                    totalSum += JSON.parse(currentNumber);
                }else{
                    if(currentNumber != ""){
...
function isCellAdjacentToSymbol(i,j){
    let answer = false;

  
        if(i > 0 && j > 0 && numbers.indexOf(data[i-1][j-1]) == -1 && data[i-1][j-1] != "."){
            answer = true;
        }
  


        if(i > 0 && numbers.indexOf(data[i-1][j]) == -1 && data[i-1][j] != "."){
            answer = true;
        }



        if(i > 0 && j < tableW -1 && numbers.indexOf(data[i-1][j+1]) == -1 && data[i-1][j+1] != "."){
            answer = true;
        }
        ...
        if(j > 0 && numbers.indexOf(data[i][j-1]) == -1 && data[i][j-1] != "." ){
            answer = true;
        }
        ...
        if(j < tableW-1 && numbers.indexOf(data[i][j+1]) == -1 && data[i][j+1] != "."){
            answer = true;
        }


        if(i < tableH-1 && j > 0 && numbers.indexOf(data[i+1][j-1]) == -1 && data[i + 1][j - 1] != "."){
            answer = true;
        }
    


        if(i < tableH-1 && numbers.indexOf(data[i+1][j]) == -1 && data[i+1][j] != "."){
            answer = true;
        }


        if(j < tableW-1 && i < tableH-1 && numbers.indexOf(data[i+1][j+1]) == -1 && data[i+1][j+1] != "."){
            answer = true;
        }
